{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 246.0, 44.0, 930.0, 507.0 ],
		"bglocked" : 0,
		"defrect" : [ 246.0, 44.0, 930.0, 507.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 296.0, 456.0, 25.0, 25.0 ],
					"id" : "obj-19",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : ""
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 256.0, 456.0, 25.0, 25.0 ],
					"id" : "obj-18",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : ""
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 176.0, 456.0, 25.0, 25.0 ],
					"id" : "obj-14",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : ""
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 176.0, 368.0, 185.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Monaco",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "compile",
					"patching_rect" : [ 336.0, 288.0, 53.0, 18.0 ],
					"id" : "obj-11",
					"fontname" : "Monaco",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 5,
					"patching_rect" : [ 80.0, 280.0, 168.0, 73.0 ],
					"id" : "obj-2",
					"fontname" : "Monaco",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 368.0, 416.0, 131.0, 20.0 ],
					"id" : "obj-16",
					"fontname" : "Monaco",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 368.0, 368.0, 113.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Monaco",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "js unSick.js",
					"patching_rect" : [ 256.0, 336.0, 160.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Monaco",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 504.0, 456.0, 25.0, 25.0 ],
					"id" : "obj-8",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : ""
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-12", 0 ],
					"hidden" : 0,
					"midpoints" : [ 265.5, 362.0, 186.0, 362.0, 186.0, 363.0, 185.5, 363.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 300.75, 363.0, 377.5, 363.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 377.5, 451.0, 513.5, 451.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 471.5, 411.0, 513.5, 411.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 345.5, 333.0, 265.5, 333.0 ]
				}
