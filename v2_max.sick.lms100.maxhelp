	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "prepend dim",
					"fontname" : "Monaco",
					"patching_rect" : [ 128.0, 424.0, 77.0, 20.0 ],
					"id" : "obj-27",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "change 541",
					"fontname" : "Monaco",
					"patching_rect" : [ 128.0, 400.0, 71.0, 20.0 ],
					"id" : "obj-25",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"text" : "zl 1082 len",
					"fontname" : "Monaco",
					"patching_rect" : [ 128.0, 376.0, 77.0, 20.0 ],
					"id" : "obj-14",
					"numinlets" : 2,
					"fontsize" : 10.0,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Monaco",
					"patching_rect" : [ 128.0, 448.0, 209.0, 20.0 ],
					"id" : "obj-22",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "print LMS100",
					"fontname" : "Monaco",
					"patching_rect" : [ 112.0, 256.0, 83.0, 20.0 ],
					"id" : "obj-13",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"numoutlets" : 0
