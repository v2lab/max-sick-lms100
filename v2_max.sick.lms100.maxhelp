...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 6.0, 418.0, 694.0, 302.0 ],
						"bglocked" : 0,
						"defrect" : [ 6.0, 418.0, 694.0, 302.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 444.0, 341.0, 733.0, 358.0 ],
										"bglocked" : 0,
										"defrect" : [ 444.0, 341.0, 733.0, 358.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"outlettype" : [ "float" ],
													"fontname" : "Monaco",
													"patching_rect" : [ 24.0, 224.0, 53.0, 20.0 ],
													"id" : "obj-2",
													"numinlets" : 2
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"fontname" : "Monaco",
													"patching_rect" : [ 32.0, 72.0, 47.0, 20.0 ],
													"id" : "obj-1",
													"numinlets" : 2
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "float" ],
													"fontname" : "Monaco",
													"patching_rect" : [ 112.0, 72.0, 53.0, 20.0 ],
													"id" : "obj-20",
													"numinlets" : 2
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "float" ],
													"fontname" : "Monaco",
													"patching_rect" : [ 168.0, 72.0, 59.0, 20.0 ],
													"id" : "obj-17",
													"numinlets" : 2
												}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 70.0, 367.0, 276.0, 273.0 ],
						"bglocked" : 0,
						"defrect" : [ 70.0, 367.0, 276.0, 273.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
