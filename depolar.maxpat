{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 34.0, 58.0, 969.0, 623.0 ],
		"bglocked" : 0,
		"defrect" : [ 34.0, 58.0, 969.0, 623.0 ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"patching_rect" : [ 0.0, 80.0, 70.0, 47.0 ],
					"id" : "obj-26",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 208.0, 216.0, 69.0, 33.0 ],
					"id" : "obj-14",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 520.0, 119.0, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b",
					"patching_rect" : [ 224.0, 496.0, 29.0, 20.0 ],
					"outlettype" : [ "bang" ],
					"id" : "obj-39",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 472.0, 143.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-30",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.op @op <p",
					"patching_rect" : [ 80.0, 376.0, 89.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-38",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "gswitch",
					"patching_rect" : [ 48.0, 408.0, 41.0, 32.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-34",
					"int" : 1,
					"numinlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"patching_rect" : [ 72.0, 528.0, 80.0, 37.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-7",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 504.0, 119.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-6",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 448.0, 155.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-54",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 568.0, 443.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-37",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 201.5, 390.0, 298.0, 390.0, 298.0, 312.0, 289.0, 312.0, 289.0, 252.0, 361.5, 252.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 345.5, 354.0, 159.5, 354.0 ]
				}
