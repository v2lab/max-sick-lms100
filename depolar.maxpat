{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 217.0, 80.0, 969.0, 623.0 ],
		"bglocked" : 0,
		"defrect" : [ 217.0, 80.0, 969.0, 623.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 168.0, 216.0, 69.0, 33.0 ],
					"id" : "obj-14",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess 1000",
					"patching_rect" : [ 168.0, 200.0, 89.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-11",
					"hidden" : 1,
					"fontname" : "Monaco",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 168.0, 248.0, 50.0, 20.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.op @op -",
					"patching_rect" : [ 120.0, 328.0, 83.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 464.0, 104.0, 150.0, 33.0 ],
					"id" : "obj-28",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "change 1.",
					"patching_rect" : [ 456.0, 200.0, 65.0, 20.0 ],
					"outlettype" : [ "", "int", "int" ],
					"id" : "obj-17",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "delay 300",
					"patching_rect" : [ 408.0, 144.0, 65.0, 20.0 ],
					"outlettype" : [ "bang" ],
					"id" : "obj-10",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b 1.",
					"patching_rect" : [ 408.0, 120.0, 47.0, 20.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess 0",
					"patching_rect" : [ 8.0, 208.0, 71.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-4",
					"hidden" : 1,
					"fontname" : "Monaco",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p copy-dim",
					"patching_rect" : [ 136.0, 296.0, 71.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-27",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "dim $1",
									"patching_rect" : [ 50.0, 172.0, 47.0, 18.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-14",
									"fontname" : "Monaco",
									"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "select 1",
					"patching_rect" : [ 336.0, 264.0, 59.0, 20.0 ],
					"outlettype" : [ "bang", "" ],
					"id" : "obj-3",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess 0.1",
					"patching_rect" : [ 488.0, 144.0, 83.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-1",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "reset",
					"patching_rect" : [ 216.0, 64.0, 41.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-2",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "gswitch",
					"patching_rect" : [ 8.0, 408.0, 41.0, 32.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-34",
					"int" : 1,
					"numinlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 616.0, 8.0, 20.0, 20.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-33",
					"numinlets" : 1,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "enable $1",
					"patching_rect" : [ 616.0, 32.0, 65.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-32",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "setall 65536, bang",
					"patching_rect" : [ 336.0, 288.0, 119.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-31",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.op @op min",
					"patching_rect" : [ 152.0, 360.0, 95.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-29",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 296.0, 224.0, 20.0, 20.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-23",
					"numinlets" : 1,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "gate",
					"patching_rect" : [ 296.0, 288.0, 35.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-21",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 296.0, 320.0, 173.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-20",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 472.0, 176.0, 50.0, 20.0 ],
					"outlettype" : [ "float", "bang" ],
					"id" : "obj-19",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "reset, color 1 0 0 0.3, circle 0.01 -45 225",
					"patching_rect" : [ 688.0, 32.0, 269.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-13",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.sketch radar @blend_enable 1",
					"patching_rect" : [ 616.0, 56.0, 221.0, 20.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-12",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.0, 272.0, 101.0, 20.0 ],
					"outlettype" : [ "jit_matrix", "" ],
					"id" : "obj-45",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 96.0, 277.0, 20.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-35",
					"fontname" : "Arial",
					"fontsize" : 11.595187,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.render radar @depth_enable 1 @blend_enable 1",
					"patching_rect" : [ 72.0, 160.0, 317.0, 20.0 ],
					"outlettype" : [ "bang", "" ],
					"id" : "obj-22",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 456.0, 224.0, 131.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-18",
					"fontname" : "Monaco",
					"fontsize" : 10.0,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-34", 0 ],
					"hidden" : 0,
					"midpoints" : [ 53.0, 195.0, 3.0, 195.0, 3.0, 393.0, 17.5, 393.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 465.5, 243.0, 327.0, 243.0, 327.0, 192.0, 69.0, 192.0, 69.0, 156.0, 81.5, 156.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 161.5, 390.0, 258.0, 390.0, 258.0, 312.0, 249.0, 312.0, 249.0, 252.0, 321.5, 252.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 305.5, 354.0, 119.5, 354.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-19", 0 ],
					"hidden" : 0,
					"midpoints" : [ 497.5, 165.0, 468.0, 165.0, 468.0, 171.0, 481.5, 171.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 88.5, 90.0, 57.0, 90.0, 57.0, 195.0, 305.5, 195.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-19", 0 ],
					"hidden" : 0,
					"midpoints" : [ 417.5, 174.0, 453.0, 174.0, 453.0, 171.0, 481.5, 171.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 445.5, 141.0, 405.0, 141.0, 405.0, 195.0, 465.5, 195.0 ]
				}
